        ...
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h1 class="text-2xl font-extrabold text-gray-900 dark:text-white sm:text-3xl text-left mb-6">
                        Downloads
                    </h1>
                    <p class="mt-2 text-sm text-gray-700 dark:text-gray-200">
                        Venom can be build manually as seen in the wiki, but, here are
                        some download links to create your OS via RootFS or Live CD
                    </p>
                </div>
            </div>
            <div
                            ...
                            {#each downloads as download}
                                {#each download.download_url as mirror}
                                    <tr>
                                        ...
                                        <td
                                            class=" px-3 py-3.5 text-sm text-gray-500 dark:text-gray-50 lg:table-cell"
                                            >{getTypeString(mirror.download_type)}</td
                                        >
                                        <td
                        ...
                        <div class="rounded-md bg-yellow-50 dark:bg-yellow-700 p-4">
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    >
                                        There was an error loading the Download Links
                                    </h3>
                                    <div
